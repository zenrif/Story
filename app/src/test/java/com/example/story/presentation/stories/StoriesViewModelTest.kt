package com.example.story.presentation.stories
...
import com.example.story.presentation.story.StoryAdapter
import com.example.story.presentation.story.StoryViewModel
import com.example.story.utils.DataDummy
import com.example.story.utils.MainDispatcherRule
...
class StoriesViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Success`() = mainDispatcherRules.runBlockingTest {
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = StoryAdapter.diffCallbackListener,
